...
pub mod syscall {
    ...
    pub fn socket(domain: u32, type_: u32, protocol: u32) -> u32 {
        let ret: u32;
        #[cfg(target_arch = "riscv32")]
        unsafe {
            asm!(
    ...
    pub fn bind(sockfd: u32, addr: *const u8, addrlen: u32) -> i32 {
        let ret: i32;
        #[cfg(target_arch = "riscv32")]
        unsafe {
            asm!(
    ...
    pub fn sendto(sockfd: u32, buf: *const u8, len: usize, flags: u32, dest_addr: *const u8, addrlen: u32) -> i32 {
        let ret: i32;
        #[cfg(target_arch = "riscv32")]
        unsafe {
            asm!(
        ...
        #[cfg(not(target_arch = "riscv32"))]
        {
            let _ = (sockfd, buf, len, flags, dest_addr, addrlen);
            ret = -1;
        }
        ret
    }

    pub fn recvfrom(sockfd: u32, buf: *mut u8, len: usize, flags: u32, src_addr: *mut u8, addrlen: *mut u32) -> i32 {
        let ret: i32;
        #[cfg(target_arch = "riscv32")]
        unsafe {
            asm!(
        ...
        #[cfg(not(target_arch = "riscv32"))]
        {
            let _ = (sockfd, buf, len, flags, src_addr, addrlen);
            ret = -1;
        }
        ret
    }
