...
impl Scheduler for RoundRobinScheduler {
    fn schedule(&mut self) -> Option<ThreadHandle> {
        // TODO: Assignment 1 - Implement schedule (pop from ready queue)
        todo!("Assignment 1: schedule")
    }

    fn enqueue(&mut self, thread: ThreadHandle) {
        // TODO: Assignment 1 - Implement enqueue (push to ready queue)
        todo!("Assignment 1: enqueue")
    }

    fn dequeue(&mut self, thread: ThreadHandle) -> bool {
        // TODO: Assignment 1 - Implement dequeue (remove from ready queue)
        todo!("Assignment 1: dequeue")
    }
